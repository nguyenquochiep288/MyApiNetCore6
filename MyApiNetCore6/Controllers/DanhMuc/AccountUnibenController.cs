...
// Type: MyApiNetCore6.Controllers.AccountUnibenController
...
public class AccountUnibenController : ControllerBase
{
  ...
  public async Task<IActionResult> GetCompany()
  {
    try
    {
      List<dm_TaiKhoan_Uniben> lstValue = await this._context.dm_TaiKhoan_Uniben.ToListAsync<dm_TaiKhoan_Uniben>();
  ...
  public async Task<IActionResult> GetCompany(int Type, string KeyWhere = "", string ValuesSearch = "")
  {
    try
    {
      ...
      List<dm_TaiKhoan_Uniben> lstValue = await this._context.dm_TaiKhoan_Uniben.Where<dm_TaiKhoan_Uniben>(KeyWhere, (object) ValuesSearch).ToListAsync<dm_TaiKhoan_Uniben>();
      return (IActionResult) this.Ok((object) new ApiResponse()
      {
        Success = true,
        Message = "Success",
  ...
  public async Task<IActionResult> GetCompany(string ID)
  {
    try
    {
      dm_TaiKhoan_Uniben Company = await this._context.dm_TaiKhoan_Uniben.FirstOrDefaultAsync<dm_TaiKhoan_Uniben>((Expression<Func<dm_TaiKhoan_Uniben, bool>>) (e => e.ID == ID));
      if (Company == null)
        return (IActionResult) this.Ok((object) new ApiResponse()
        {
          Success = false,
  ...
  public async Task<IActionResult> PutCompany(string MA, dm_TaiKhoan_Uniben Company)
  {
    try
    {
      ...
      dm_TaiKhoan_Uniben TaiKhoan_Misa = await this._context.dm_TaiKhoan_Uniben.FirstOrDefaultAsync<dm_TaiKhoan_Uniben>((Expression<Func<dm_TaiKhoan_Uniben, bool>>) (e => e.ID == Company.ID));
      if (TaiKhoan_Misa != null)
      {
        ...
        this._context.Entry<dm_TaiKhoan_Uniben>(TaiKhoan_Misa).State = EntityState.Modified;
      }
      AuditLogController auditLog = new AuditLogController(this._context, this._configuration);
      auditLog.InserAuditLog();
      int num = await this._context.SaveChangesAsync();
      dm_TaiKhoan_Uniben OKCompany = await this._context.dm_TaiKhoan_Uniben.FirstOrDefaultAsync<dm_TaiKhoan_Uniben>((Expression<Func<dm_TaiKhoan_Uniben, bool>>) (e => e.ID == Company.ID));
      return (IActionResult) this.Ok((object) new ApiResponse()
      {
        Success = true,
        Message = "Success",
  ...
  public async Task<ActionResult<dm_TaiKhoan_Uniben>> PostCompany(dm_TaiKhoan_Uniben Company)
  {
    try
    {
      if (this.CompanyExistsMA(Company.MASOTHUE))
        return (ActionResult<dm_TaiKhoan_Uniben>) (ActionResult) this.Ok((object) new ApiResponse()
        {
          Success = false,
          Message = $"Đã tồn tại{Company.MASOTHUE} trong dữ liệu!",
          Data = (object) ""
        });
      this._context.dm_TaiKhoan_Uniben.Add(Company);
      AuditLogController auditLog = new AuditLogController(this._context, this._configuration);
      auditLog.InserAuditLog();
      int num = await this._context.SaveChangesAsync();
      dm_TaiKhoan_Uniben OKCompany = await this._context.dm_TaiKhoan_Uniben.FirstOrDefaultAsync<dm_TaiKhoan_Uniben>((Expression<Func<dm_TaiKhoan_Uniben, bool>>) (e => e.ID == Company.ID));
  ...
  public async Task<IActionResult> DeleteCompany(string ID)
  {
    try
    {
      ...
      this._context.dm_TaiKhoan_Uniben.Remove(Company);
      AuditLogController auditLog = new AuditLogController(this._context, this._configuration);
      auditLog.InserAuditLog();
      int num = await this._context.SaveChangesAsync();
      return (IActionResult) this.Ok((object) new ApiResponse()
  ...
  {
    return this._context.dm_TaiKhoan_Uniben.Any<dm_TaiKhoan_Uniben>((Expression<Func<dm_TaiKhoan_Uniben, bool>>) (e => e.ID == ID));
  }

  private bool CompanyExistsMA(string MA)
  {
    return this._context.dm_TaiKhoan_Uniben.Any<dm_TaiKhoan_Uniben>((Expression<Func<dm_TaiKhoan_Uniben, bool>>) (e => e.MASOTHUE == MA));
  }

  private bool CompanyExists(dm_TaiKhoan_Uniben Company)
  {
    return this._context.dm_TaiKhoan_Uniben.Any<dm_TaiKhoan_Uniben>((Expression<Func<dm_TaiKhoan_Uniben, bool>>) (e => e.MASOTHUE == Company.MASOTHUE && e.ID != Company.ID));
  }
}
