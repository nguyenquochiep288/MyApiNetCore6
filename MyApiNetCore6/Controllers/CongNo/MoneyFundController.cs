...
namespace MyApiNetCore6.Controllers
{
    ...
    public class MoneyFundController : ControllerBase
    {
        ...
        public async Task<ActionResult<List<v_ThongKeCongNo_ChiTiet>>> PostDetail([FromBody] v_ThongKeQuyTien KhachHang)
        {
            try
            {
                ...
                var rlsPhieuThu = from itm in _context.ct_PhieuThu
                                  where itm.ID_TAIKHOANNGANHANG == KhachHang.ID_TAIKHOANNGANHANG
