...
namespace MyApiNetCore6.Data
{
    public class dbTrangHiepPhatContext : DbContext
    {
        ...
        public virtual DbSet<dm_HangHoa_KhungGia_Master> dm_HangHoa_KhungGia_Master { get; set; }
        public virtual DbSet<view_dm_HangHoa_KhungGia_HangHoa> view_dm_HangHoa_KhungGia_HangHoa { get; set; }
        public virtual DbSet<view_dm_HangHoa_KhungGia> view_dm_HangHoa_KhungGia { get; set; }
        ...
        public virtual DbSet<ct_HoaDon_ChiTiet> ct_HoaDon_ChiTiet { get; set; }
        public virtual DbSet<dm_HangHoa_KhungGia_HangHoa> dm_HangHoa_KhungGia_HangHoa { get; set; }
        
        #endregion

        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<dm_LoaiHoaDon>()
     .HasKey(m => new { m.LOC_ID, m.ID, });
            modelBuilder.Entity<dm_HangHoa_KhungGia_HangHoa>()
      .HasKey(m => new { m.LOC_ID, m.ID, });
            modelBuilder.Entity<ct_HoaDon>()
       .HasKey(m => new { m.LOC_ID, m.ID, });
            modelBuilder.Entity<ct_HoaDon_ChiTiet>()
       .HasKey(m => new { m.LOC_ID, m.ID, });
            modelBuilder.Entity<dm_HangHoa_KhungGia>()
        .HasKey(m => new { m.LOC_ID, m.ID, });
            modelBuilder.Entity<dm_TaiKhoan_Misa>()
         .HasKey(m => new { m.LOC_ID, m.ID, });
            modelBuilder.Entity<dm_TaiKhoan_Uniben>()
          .HasKey(m => new { m.LOC_ID, m.ID, });
            modelBuilder.Entity<uniben_dm_LienKet_NhanVien>()
          .HasKey(m => new { m.LOC_ID, m.ID, });
            modelBuilder.Entity<uniben_dm_LienKet_HangHoa>()
          .HasKey(m => new { m.LOC_ID, m.ID, });
            modelBuilder.Entity<uniben_dm_LienKet_KhachHang>()
          .HasKey(m => new { m.LOC_ID, m.ID, });
            modelBuilder.Entity<view_dm_HangHoa_KhungGia>()
           .HasKey(m => new { m.LOC_ID, m.ID, });
            modelBuilder.Entity<view_dm_HangHoa_KhungGia_HangHoa>()
           .HasKey(m => new { m.LOC_ID, m.ID, });
            modelBuilder.Entity<dm_HangHoa_KhungGia_Master>()
           .HasKey(m => new { m.LOC_ID, m.ID, });
